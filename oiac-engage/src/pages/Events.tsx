      ...
      {items.length === 0 ? (
        ...
        <>
          {upcoming.length > 0 ? (
            ...
            <EmptyState title="No upcoming events" description="New events will appear here when they are scheduled." />
          )}
          {past.length > 0 ? (
            ...
            <EmptyState title="No past events" description="Events you attend will appear here." />
          )}
        </>
      )}
    </div>
